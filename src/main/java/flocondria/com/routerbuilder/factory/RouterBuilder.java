...
public class RouterBuilder {
    ...
    public RouterBuilder add(HttpMethod method, String path, HandlerFunction<ServerResponse> handler) {
    ...
    public RouterFunction<ServerResponse> build() throws NoSuchAlgorithmException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {

        String hashed = hash("flocondria" + Long.toString(Instant.now().getEpochSecond()));

        Logger logger = LoggerFactory.getLogger(RouterBuilder.class);
